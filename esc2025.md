...
NOTE — TVM's streaming service automatically creates these links by cutting the live broadcast following their schedule. For some reason, this schedule said that it would end at 22:45 CET, but the show ran over by almost an hour, so that last hour is currently missing... The people maintaining the website should add it manually at some point tomorrow.
